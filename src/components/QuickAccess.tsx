...
export function QuickAccess() {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-background via-secondary/10 to-background relative overflow-hidden">
      ...
      <div className="absolute top-10 left-10 w-32 h-32 bg-gradient-blue opacity-3 rounded-full blur-3xl" />
      <div className="absolute bottom-10 right-10 w-24 h-24 bg-gradient-purple opacity-4 rounded-full blur-3xl" />
      <div className="absolute top-1/2 left-1/3 w-20 h-20 bg-gradient-teal opacity-3 rounded-full blur-3xl" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        >
          ...
          >
            <div className="w-2 h-2 bg-gradient-cool rounded-full animate-pulse" />
